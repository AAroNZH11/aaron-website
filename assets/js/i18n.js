var translations = {
  ...
  zh: {
    ...
    'about.heading': '关于我',
    'about.bio1': '我目前在华盛顿大学攻读生物统计硕士学位，本科毕业于杜克大学和昆山杜克大学，主修计算机科学。我的兴趣主要集中在数据科学与公共卫生的结合，关注如何用统计方法分析和解决实际的健康问题。',
    'about.bio2': '我目前在华盛顿大学担任Robin Mejia教授的助教，负责本科课程BIOST310，主要职责是组织讨论课、批阅作业和试卷，并为本科生们解答统计学上的问题。',
